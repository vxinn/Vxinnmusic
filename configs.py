...
class Configs:
    ...
    CHANNEL_LINK = getenv("CHANNEL_LINK", "https://t.me/kayzuchannel")
    GROUP_LINK = getenv("GROUP_LINK", "https://t.me/KayzuSupport")
    UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Kayzyu/EnakeunMusic")
